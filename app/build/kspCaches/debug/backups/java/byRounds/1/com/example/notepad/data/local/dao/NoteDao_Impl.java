...
public final class NoteDao_Impl implements NoteDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfPurgeDeletedSyncedNotes;
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNoteEntity = new EntityInsertionAdapter<NoteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notes` (`id`,`title`,`content`,`createdAt`,`updatedAt`,`isSynced`,`isDeleted`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__preparedStmtOfSoftDelete = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE notes SET isDeleted = 1, isSynced = 0, updatedAt = ? WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfPurgeDeletedSyncedNotes = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM notes WHERE isDeleted = 1 AND isSynced = 1";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object purgeDeletedSyncedNotes(final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfPurgeDeletedSyncedNotes.acquire();
        try {
          __db.beginTransaction();
          try {
            _stmt.executeUpdateDelete();
          ...
          __preparedStmtOfPurgeDeletedSyncedNotes.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public List<NoteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new NoteEntity(_tmpId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpUpdatedAt,_tmpIsSynced,_tmpIsDeleted);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<NoteEntity> observeNoteById(final long id) {
      ...
      public NoteEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp_1 = _cursor.getInt(_cursorIndexOfIsDeleted);
            _tmpIsDeleted = _tmp_1 != 0;
            _result = new NoteEntity(_tmpId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpUpdatedAt,_tmpIsSynced,_tmpIsDeleted);
          } else {
            _result = null;
          }
          return _result;
  ...
  public Object markAsSynced(final List<Long> ids, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        _stringBuilder.append("UPDATE notes SET isSynced = 1 WHERE id IN (");
